	...
	return (
		<SafeAreaView className="bg-white h-full">
			<View className="h-full p-10 flex relative">
				<Text className="font-poppins-bold text-primary-300 text-4xl mb-3">Login now</Text>
				...
				<View className="w-full p-4 flex justify-center align-center border-2 border-gray-500 rounded-xl mb-3">
					<TextInput
						className="text-black font-poppins"
				...
				<TouchableOpacity className="w-3/5 h-12 bg-primary-300 flex justify-center items-center rounded-xl mb-6 self-center">
					<Text className="text-white font-poppins-semibold text-lg">Login</Text>
				</TouchableOpacity>
